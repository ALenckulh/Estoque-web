...
import { listSegments } from "@/lib/services/segment/list-segments";

// GET -> listar segmentos por enterprise_id
export async function GET(request: Request) {
  try {
    ...
    const segments = await listSegments(enterprise_id);
...
/**
 * @swagger
 * /api/segment/listSegment:
 *   get:
 *     summary: Lista segmentos
 *     description: Retorna segmentos (safe_delete=true) de um enterprise.
 *     parameters:
 *       - in: header
